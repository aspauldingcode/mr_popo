...
app.get('/api/offenses', (req, res) => {
    ...
    // Using the same db helper from the bot package
    // For now, assuming db.statements is available or adding a generic getter
    try {
        const rows = db.statements_raw?.getAllOffenses?.all() || []; // Placeholder logic, requires bot db update
